...
public class SharedService implements ISharedService {
    ...
    @Override
    public Object getSharedFiles(FileSearch fileSearch, PageModel pageModel) {
        ...
        return webClientConnector.connectWebClient(EPORTAFOLIO_ROUTE)
                .post()
                .uri(EPORTAFOLIO_SERVICE + "/file/shared?page=" + pageModel.getPage() + "&size=" + pageModel.getSize())
